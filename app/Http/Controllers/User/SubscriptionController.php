...
class SubscriptionController extends Controller
{
    ...
    public function updateSubscription(Request $request)
    {
        try {
            ...
            $route = GatewayRedirect::paymentRoute(['package_id' => $request->package_id, 'code' => $subscription->code, 'user_id' => $subscription->user_id, 'billing_cycle' => $request->billing_cycle, 'billing_price' => $price], $price, $currency, generateUniqueId(), $request, $paymentType);
    ...
    public function storeCredit(Request $request)
    {
        ...
        try {
            ...
            $route = GatewayRedirect::paymentRoute(['package_id' => $request->credit_id, 'code' => 'onetime', 'user_id' => auth()->user()->id], $price, $currency, generateUniqueId(), $request, 'single');
